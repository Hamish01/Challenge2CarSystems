...
namespace CivSem1Challenge2_CarSystem
{
    public class UI
    {
            ...
            switch(input) {
                ...
                case "1":
                    ...
                    for(int i = 0; i < CarDealers.Count ; i++){
                        Console.WriteLine(this.CarDealers[i].GetAddress());
                    }
                    //----------
                    break;
                ...
                case "5":
                    ...
                    numCars = this.GetTotalCarsInCarDealers();
        ...
        private int GetTotalCarsInCarDealers()
        {
            int x = 0;
            foreach(var i in CarDealers){
                x = x + i.Listings.Count;
            }
            return x;
        }
